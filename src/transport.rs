...
bitflags::bitflags! {
    pub struct PositionBits: sys::jack_transport_bits_t {
        const BBT               = sys::jack_position_bits_t_JackPositionBBT;
        const TIMECODE          = sys::jack_position_bits_t_JackPositionTimecode;
        const BBT_OFFSET        = sys::jack_position_bits_t_JackBBTFrameOffset;
        const AUDIO_VIDEO_RATIO = sys::jack_position_bits_t_JackAudioVideoRatio;
        const VIDEO_OFFSET      = sys::jack_position_bits_t_JackVideoFrameOffset;
        const TICK_DOUBLE       = sys::jack_position_bits_t_JackTickDouble;
    }
}
...
impl TransportPosition {
    ...
    #[inline]
    pub fn valid(&self) -> PositionBits {
        unsafe { PositionBits::from_bits_unchecked(self.0.valid) }
    }
    #[inline]
    pub fn bar(&self) -> i32 {
        self.0.bar
    ...
    #[inline]
    pub fn audio_frames_per_video_frame(&self) -> f32 {
    ...
    #[inline]
    pub fn set_audio_video_ratio(&mut self, audio_frames_per_video_frame: f32) {
        self.0.valid |= sys::jack_position_bits_t_JackAudioVideoRatio;
        self.0.audio_frames_per_video_frame = audio_frames_per_video_frame;
    }
    #[inline]
